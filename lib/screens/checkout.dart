                            ...
                            children: <Widget>[
                              Container(
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(
                                      fontSize: 25,
                                      fontWeight: FontWeight.w400,color: Colors.lightGreen[800]),
                                ),
                              ),
                              Container(
                                margin: EdgeInsets.only(right: 25),
                                child: Text(
                                  ...
                                  style: TextStyle(
                                      fontWeight: FontWeight.w600,
                                      fontSize: 28,color: Colors.lightGreen[800]),
                                ),
                              )
                            ],
                          ),
        ...
        ListTile(
          ...
          leading: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(image: AssetImage(cartList[i].image)),
                  color: Colors.lightGreen[800])),
          ...
          subtitle: Text("\$${int.parse(cartList[i].price) * cartList[i].count}",
              style: TextStyle(fontWeight: FontWeight.w800,
                  color: Colors.lightGreen[800], fontSize: 16)),
